...
Controller-level DTOs live in `com.comp5348.store.order.presentation.dto` and are framework-agnostic so they can be wired into the HTTP layer of your choice.
...
- `presentation` – request/response models and controller wrapper for the public API, plus HTTP adapters.
